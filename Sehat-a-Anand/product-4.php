...
<body>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Coconut Cascade
            </h1>
            <div class="d-inline-flex mb-lg-5">
                ...
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Coconut Cascade</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    <div class="mx-5 d-flex flc">
        <div class="img">
            <img src="img/menu-4.jpg" alt="Img" class="br-20 w-75">
            <div class=" mt-5 d-flex flex-column">
                ...
                <a class="btn btn-success rounded mt-3" href="login-warn.html">Add To Cart</a>
            </div>
        </div>
        <div class="d-flex w-100 flex-column align-items-center">
            <h1 class="text-uppercase ml-5">Coconut Cascade
            </h1>
            <div class="container my-5">
                <h5 class="text-dark">
                    Pistachios are bursting with the fiber, minerals, and
                    unsaturated fat that can help keep your blood sugar,
                    blood pressure, and cholesterol in check. Their fiber and
                    protein can make you feel fuller for longer. This fiber can
                    also have a positive effect on your gut by aiding "good"
                    bacteria. So , "Sehat-a-Anand - Flavorful grace , Wellness embrace"
                    provides you a delicious beverage that combine
                    pistachios, calcium rich fox nuts in the form of a
                    affordable ready to use milk powder . So , instead of
                    having a beverage with chemical preservatives one must
                    enjoy our ' luscious pista '. Natural ingredients are used in
                    our product. We have added our product in our list
                    because for us CONSUMER SATISFACTION IS MOST
                    IMPORTANT ..
            ...
            <div class="d-flex mt-3 flex-column align-items-center">
                <h1 class="text-primary">INGREDIENTS
                </h1>
                ...
                <div class="d-flex ">
                    ...
                    <div class="d-flex flex-column container">
                        ...
                        <p class="mt-3 text-deatail mx-5">
                            Saffron is rich in plant compounds
                            that act as antioxidants, such as
                            crocin, crocetin, safranal, and
                            kaempferol. Antioxidants help
                ...
                <div class="d-flex mt-5">
                    <div class="d-flex flex-column container">
                        <h3 class="mt-4 text-center">PISTACHIOS</h3>
                        <p class="mt-3 text-deatail mx-5">
                            Pistachios are bursting with the fiber,
                            minerals, and unsaturated fat that can
                            help keep your blood sugar, blood
                            pressure, and cholesterol in check.

                        </p>

                    </div>
                    <img class="img w-40 br-20 ml-5 mt-3" src="img/ing-13.jpg" alt="">

                </div>
                <div class="d-flex mt-5">
                    <img class="img w-40 br-20 ml-5 mt-3" src="img/ing-1.jpg" alt="">
                    <div class="d-flex flex-column container">
                        <h3 class="mt-4 text-center">MAKHANE /FOX NUTS</h3>
                        <p class="mt-3 text-deatail mx-5">
                            ...
                            source of proteins, carbohydrates, fibre, potassium,
                            iron, and zinc. It also help us to overcome insomnia and
                ...
                <div class="d-flex mt-5">
                    <div class="d-flex flex-column container">
                        <h3 class="mt-4 text-center">GREEN CARDAMOM
                        </h3>
                        <p class="mt-3 text-deatail mx-5">
                ...
                <div class="d-flex mt-5">
                    ...
                    <div class="d-flex flex-column container">
                        ...
                        <p class="mt-3 text-deatail mx-5">
                            Apart from regenerating blood circulation in our body,
                            it is also useful in anaemia, pale skin, dizziness, fatigue
                            and weakness. Therefore, people suffering from low
