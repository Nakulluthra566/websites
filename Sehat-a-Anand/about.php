        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    <h6 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>LOADED WITH GOODNESS OF NUTS</h6>
                    <h6 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>RICH SOURCE OF CALCIUM</h6>
                    <h6 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>USAGE OF NATURAL PRODUCTS</h6>
                    <h6 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>FREE FROM CHEMICAL PRESERVATIVES</h6>
                    <h6 class="mb-3"><i class="fa fa-check text-primary mr-3"></i>OUR PRODUCTS ARE SUGAR FREE</h6>
                </div>
            </div>
        </div>
    </div>
