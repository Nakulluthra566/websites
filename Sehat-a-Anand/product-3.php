...
<body>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Luscious Pista
            </h1>
            <div class="d-inline-flex mb-lg-5">
                ...
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Luscious pista</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="mx-5 d-flex flc">
        <div class="img">
            <img src="img/menu-3.jpg" alt="Img" class="br-20 w-75">
        ...
        <div class="d-flex w-100 flex-column align-items-center">
            <h1 class="text-uppercase ml-5">Luscious pista
            </h1>
            <div class="container my-5">
                <h5 class="text-dark">
                    ...
                    bacteria. So , "Sehat-a-Anand - A TRULY HEALTHY LIFESTYLE"
