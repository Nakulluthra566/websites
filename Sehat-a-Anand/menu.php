...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="d-flex justify-content-center">
            ...
            <div
                class="product-card mb-5 d-flex flex-column align-items-center justify-content-center bg-primary br-10 overflow-hidden">
                <img src="img/menu-1.jpg" class="w-70 br-10 mb-4 " alt="">
                <h3>Choco Delicacy</h3>
                <h4>Price: $5</h4>
                <h4>Shipping: Free</h4>
                <div class="btns mt-3">
                    <a class="btn btn-dark rounded text-light" href="product-1.html">Learn More</a>
                    <a class="btn btn-success rounded" href="#">Add To Cart</a>
                </div>
            </div>
            <div
                class="product-card d-flex flex-column align-items-center justify-content-center bg-warning br-10 overflow-hidden">
                <img src="img/menu-2.jpg" class="w-70 br-10 mb-4 " alt="">
                <h3>Nuts Harmony</h3>
                <h4>Price: $5</h4>
                <h4>Shipping: Free</h4>
                <div class="btns mt-3">
                    <a class="btn btn-dark rounded text-light" href="product-2.html">Learn More</a>
                    <a class="btn btn-success rounded" href="#">Add To Cart</a>
                </div>
            </div>
            <div
                class="product-card d-flex flex-column align-items-center justify-content-center bg-success br-10 overflow-hidden">
                <img src="img/menu-3.jpg" class="w-70 br-10 mb-4 " alt="">
                <h3>Luscious Pista</h3>
                <h4>Price: $5</h4>
                <h4>Shipping: Free</h4>
                <div class="btns mt-3">
                    <a class="btn btn-dark rounded text-light" href="product-3.html">Learn More</a>
                    <a class="btn btn-light rounded" href="#">Add To Cart</a>
                </div>
            </div>
            <div
                class="product-card d-flex flex-column align-items-center justify-content-center bg-dark br-10 overflow-hidden">
                <img src="img/menu-4.jpg" class="w-70 br-10 mb-4 " alt="">
                <h3 class="text-white">Coconut cascade</h3>
                <h4 class="text-white">Price: $5</h4>
                <h4 class="text-white">Shipping: Free</h4>
                <div class="btns mt-3">
                    <a class="btn btn-light rounded text-dark" href="product-4.php">Learn More</a>
                    <a class="btn btn-success rounded" href="#">Add To Cart</a>
                </div>
            </div>
        </div>
